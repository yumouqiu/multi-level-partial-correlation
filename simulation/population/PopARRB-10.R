...
write.table(Res0, "Pop0416ARRB200-50-10-5-0520-0.txt", row.names = FALSE, col.names = FALSE)
write.table(Res3, "Pop0416ARRB200-50-10-5-0520-3.txt", row.names = FALSE, col.names = FALSE)
write.table(Res5, "Pop0416ARRB200-50-10-5-0520-5.txt", row.names = FALSE, col.names = FALSE)