...
R = 100
#set.seed(1000)
#precision = BD2(100, 3, tau2 = 1.2, rho = c(0.2, 0.4, 0.8, 1))
#precision = BD3(100, 3, tau2 = 1, rho = c(0.3, 0.9))
precision = BD4(100, 3, tau2 = 1, rho = c(0.25, 0.8))
...
write.table(Res05, "IndBD4-100-100-3-05.txt", row.names = FALSE, col.names = FALSE)
...
write.table(Res03, "IndBD4-100-100-3-03.txt", row.names = FALSE, col.names = FALSE)
...
write.table(Res0, "IndBD4-100-100-3-0.txt", row.names = FALSE, col.names = FALSE)