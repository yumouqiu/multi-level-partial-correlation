...
write.table(Res05, "IndARR2-100-50-05.txt", row.names = FALSE, col.names = FALSE)
...
write.table(Res03, "IndARR2-100-50-03.txt", row.names = FALSE, col.names = FALSE)
...
write.table(Res0, "IndARR2-100-50-0.txt", row.names = FALSE, col.names = FALSE)